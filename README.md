...
Conversation indexing is intentionally read-only. CiteAnything works additionally
support an explicit pull/edit/push workflow:
...
- checks out a durable CiteAnything work for local Codex/Claude/Cursor editing and
  pushes it back with optimistic revision-conflict protection.
...
edit, and push again; SyncAnything never silently overwrites the newer cloud
revision. With China and international accounts connected together, select one
explicitly:
